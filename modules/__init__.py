...
from .models import (
    Work, Release, AniListWork, RSSFeedItem,
    WorkType, ReleaseType, DataSource,
    DataValidator, DataNormalizer
)

# Version information
__version__ = "1.0.0"
__author__ = "MangaAnime-DevAPI Agent"
__description__ = "Backend API and database functionality for Anime/Manga information delivery system"
...
__all__.extend(['initialize_system', 'get_system_info', 'get_anilist_collector', 'get_rss_collector'])