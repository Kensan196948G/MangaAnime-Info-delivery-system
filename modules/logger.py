...
class StructuredLogger:
    ...
    def log_api_call(self, source: str, url: str, status_code: int = None, 
    ...
    def log_data_processing(self, stage: str, input_count: int, output_count: int, 
                           filtered_count: int = 0, duration: float = None):
        """データ処理ログ"""
        log_data = {
    ...
    def log_notification_sent(self, notification_type: str, recipient: str, 
                             item_count: int, success: bool, error: str = None):
        """通知送信ログ"""
        log_data = {
