...
if __name__ == "__main__":
    ...
    print("Testing rate limiter with 10 calls (should take ~2 seconds)...")
    start = time.time()
    ...
    print(f"Remaining calls: {test_limiter.get_remaining_calls()}")
    print(f"Time until next call: {test_limiter.get_time_until_next_call():.2f}s")
