...
class TestPerformance:
    ...
    def test_database_scalability_analysis(self, mock_connect):
        ...
        for batch_size in [100, 500, 1000]:
            ...
            assert elapsed_time < 2.0, f"Mocked database operations too slow for {batch_size} records: {elapsed_time}s"
    ...
    def test_performance_regression_detection(self):
        ...
        assert all(
            abs((current_metrics[metric] - baseline_metrics[metric]) / baseline_metrics[metric]) <= regression_threshold
