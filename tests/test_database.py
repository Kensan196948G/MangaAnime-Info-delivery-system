...
class TestDatabaseManager:
    ...
    def test_database_initialization(self, temp_db):
        ...
        expected_works_columns = ['id', 'title', 'title_kana', 'title_en', 'type', 'official_url', 'created_at']
        ...
        expected_releases_columns = ['id', 'work_id', 'release_type', 'number', 'platform', 'release_date', 'source', 'source_url', 'notified', 'created_at']
    ...
    @pytest.mark.db
    def test_unique_constraint_enforcement(self, temp_db, sample_work_data, sample_release_data):
    ...
    @pytest.mark.db
    def test_query_unnotified_releases(self, temp_db, sample_work_data, sample_release_data):
        ...
        for i, release in enumerate(releases):
            ...
            cursor.execute("""
                ...
                VALUES (?, ?, ?, ?, ?, ?, ?, ?)
            """, (
                release['work_id'], release['release_type'], f"episode_{i}", 
                release['platform'], release['release_date'], release['source'], 
                release['source_url'], release['notified']
            ))
    ...
    @pytest.mark.db
    def test_update_notification_status(self, temp_db, sample_work_data, sample_release_data):
