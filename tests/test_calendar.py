...
try:
    ...
    class CalendarManager:
        ...
        def create_event(self, title, description, start_time, end_time=None, location=None):
            """Mock create event"""
...
class TestCalendarManager:
    ...
    def test_disabled_calendar(self):
        ...
        result = manager.create_event("Test Event", "Test Description", "2024-01-07T10:00:00")
...
class TestCalendarIntegration:
    ...
    def test_error_recovery(self, mock_calendar):
        ...
        mock_calendar.events().insert().execute.side_effect = [
            HttpError(resp=Mock(status=500), content=b'Server Error'),  # First call fails
...
class TestCalendarSecurity:
    ...
    def test_service_account_authentication(self):
        ...
        assert manager.config["calendar"]["service_account_file"] == "test_service_account.json"
...
class TestCalendarUtilities:
    ...
    def test_event_conflict_detection(self):
        ...
        events = [
            ...
            {"start": "2024-01-07T17:00:00", "end": "2024-01-07T18:00:00"}   # No overlap
        ]
