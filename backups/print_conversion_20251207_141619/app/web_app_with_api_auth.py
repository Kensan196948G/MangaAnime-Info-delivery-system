...
try:
    ...
    print("Warning: API authentication module not found. API endpoints will not be protected.")
...
if __name__ == '__main__':
    ...
    print("\n" + "="*60)
    print("Flask Web Application with API Key Authentication")
    print("="*60)
    print(f"API Authentication: {'Enabled' if API_AUTH_ENABLED else 'Disabled'}")
    print(f"Server URL: http://127.0.0.1:5000")
    print(f"Dashboard: http://127.0.0.1:5000/dashboard")
    if API_AUTH_ENABLED:
        print(f"Login: http://127.0.0.1:5000/login")
        print(f"API Key Management: http://127.0.0.1:5000/auth/api-keys")
    print("="*60 + "\n")
