...
logger = logging.getLogger(__name__)
        ...
        logger.info("\nCommands:")
        logger.info("  migrate  - Execute full migration process")
        logger.info("  verify   - Verify existing migration")
        logger.info("  rollback - Rollback to latest backup")
        sys.exit(1)
    ...
    if command == "migrate":
        ...
        logger.info("Valid commands: migrate, verify, rollback")
        sys.exit(1)
