...
def test_configuration():
    ...
    try:
        ...
        print(f"✓ Database config: path={db_config.path}, backup_enabled={db_config.backup_enabled}")
...
def test_data_models():
    ...
    try:
        from modules.models import Work, Release, WorkType, ReleaseType, DataNormalizer, DataValidator
