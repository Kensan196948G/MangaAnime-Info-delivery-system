...
if __name__ == '__main__':
    ...
    logger.info("\n=== 統合準備完了 ===")
    logger.info(f"Total routes: {len(result['routes'])}")
    logger.info(f"Protected routes needed: {len(result['protected_routes'])}")
